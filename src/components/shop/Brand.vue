    ...
    export default {
        ...
        methods:{
            ...
            queryDate:function (page) {
                ...
                var zy=this
                this.$axios.post("http://192.168.235.1:8082/BrandController/getBrandDate",this.$qs.stringify(params)).then(function (res) {
            ...
            updateById:function () {
              ...
              this.$axios.post("http://192.168.235.1:8082/BrandController/updateBrand",this.$qs.stringify(brand)).then(function () {
                alert("修改成功");
          ...
          addBrand:function () {
              var zy=this;
            this.$axios.post("http://192.168.235.1:8082/BrandController/addBrand",this.$qs.stringify(this.formAdd)).then(function (res) {
              alert("新增成功");
          ...
          handleDelete:function (index,data) {
            var zy=this;
            this.$axios.get("http://192.168.235.1:8082/BrandController/delete?id="+data.id+"").then(function (res) {
              alert("删除成功");
              zy.chaxun();
            }).catch(function () {
              alert("删除失败")
